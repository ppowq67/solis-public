...
async function _0x38d46c() {
    try {
        const _0x7f2984 = await fetch(API_BASE_URL.replace(/\/+$/, ''), {
            'method': 'POST',
...
async function _0x1942a1() {
    try {
        const _0x135bff = await fetch(API_BASE_URL.replace(/\/+$/, ''), {
            'method': 'POST',
            'headers': {'Content-Type': 'application/json'},
            'body': JSON.stringify({'action': 'subscription'}),
            'method': 'GET',
...
class _0x4101c7 {
    ...
    async ['checkTemplateAccess'](_0x282933) {
            try {
                const _0x2ad5e2 = window['API_BASE_URL'] || 'https://api.solisai.video/api',
                    _0x2b5436 = _0x5db2ba();
                try {
                    const _0x5e4109 = await fetch(_0x2ad5e2 + '/', {
                        'method': 'POST',
                        'headers': {'Content-Type': 'application/json'},
                        'body': JSON.stringify({'action': 'subscription'}),
                        'method': 'GET',
    ...
    async ['updateWatermarkToggleState']() {
            ...
            if (!_0x2bf8d9)
                return;
            try {
                const _0x353f23 = await fetch(API_BASE_URL.replace(/\/+$/, ''), {
                    'method': 'POST',
                    'headers': {'Content-Type': 'application/json'},
                    'body': JSON.stringify({'action': 'subscription'}),
                    'headers': _0x5db2ba(),
    ...
    async ['loadAndDisplayStorageInfo']() {
            try {
                ...
                const _0x2e731f = await fetch(API_BASE_URL.replace(/\/+$/, ''), {
                    'method': 'POST',
                    'headers': {'Content-Type': 'application/json'},
                    'body': JSON.stringify({'action': 'subscription'}),
                    'method': 'GET',
