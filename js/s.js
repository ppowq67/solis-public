...
async function _0x38d46c() {
    try {
        const _0x7f2984 = await fetch(API_BASE_URL + '/?action=subscription&t=' + Date['now'](), {
            'method': 'GET',
            'headers': _0x5db2ba(),
            'credentials': 'include',
            'cache': 'no-store'
...
async function _0x1942a1() {
    try {
        const _0x135bff = await fetch(API_BASE_URL + '/?action=subscription', {
            'method': 'GET',
            'headers': {
                'Content-Type': 'application/json'
            },
...
class _0x4101c7 {
    ...
    async ['checkTemplateAccess'](_0x282933) {
            try {
                const _0x2ad5e2 = window['API_BASE_URL'] || 'https://api.solisai.video/api',
                    _0x2b5436 = _0x5db2ba();
                try {
                    const _0x5e4109 = await fetch(_0x2ad5e2 + '/?action=subscription', {
                        'method': 'GET',
                        'headers': _0x2b5436,
                        'credentials': 'include'
                    });
    ...
    async ['updateWatermarkToggleState']() {
            ...
            if (!_0x2bf8d9)
                return;
            try {
                const _0x353f23 = await fetch(API_BASE_URL + '/?action=subscription&t=' + Date['now'](), {
                    'headers': _0x5db2ba(),
                    'credentials': 'include',
                    'cache': 'no-store'
                });
    ...
    async ['loadAndDisplayStorageInfo']() {
            try {
                ...
                const _0x2e731f = await fetch(API_BASE_URL + '/?action=subscription', {
                    'method': 'GET',
                    'headers': _0x2a3a67,
                    'credentials': 'include'
                });
